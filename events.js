...
function adcContato() {
    ...
    fetch(API_URL+'/contatos', { //coloca só o url base pq pode ter outras api e concatena a que vai ser usada
         method: 'POST',
...
function atualizarLista(){    
    ...
    // let busca = document.getElementById("busca_input");
    // busca.addEventListener("keyup", e => {
    //     let buscaresult = e.target.value;
    //     console.log(buscaresult);})
    //    let encontrado = lista_busca.filter(busca => {
    //     //    return .includes(busca) || //.includes(busca);
    //     })
